...
| `town_portal_enter_failed` | Hover, Distanz, Projektion oder Input verhinderten den sicheren Klick; die Session bricht nicht ab, sondern speichert aus dem aktuellen Gebiet und wiederholt denselben Queue-Index |
