...
CSS-Custom-Properties definieren Ember, Gold, Crimson, Flächen, Text, Fokus, Abstände und semantische Zustände. Die fast schwarzen Flächen bilden die Grundebenen; gedämpftes Feuerorange markiert Auswahl, Fortschritt und primäre Aktionen, statt große Karten aufzuhellen. Das Town-Portal-Zeichen ist ein originales, lokal ausgeliefertes PNG. Lucide-Icons ergänzen sichtbaren Text und sind dekorativ markiert; Status wird nie nur durch Farbe vermittelt.
