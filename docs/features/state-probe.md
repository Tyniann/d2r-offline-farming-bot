...
| `--object-inspect <label>` | Isolierter Gate-23.0-Modus: ein read-only Area-Report aller Objekte mit Mode und Katalogname plus Schlüsselstapel mit Active/Base-Statlisten und Stat 70; kein Spielinput |
