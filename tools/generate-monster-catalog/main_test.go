...
func TestReadAndSelectBossesByHCIdx(t *testing.T) {
	...
	if err != nil || len(selected) != 16 || selected[0].Row.HCIdx != 0 || selected[15].Row.HCIdx != 735 {
...
func TestRenderedMonsterCatalogsAreVersionBoundAndSynchronized(t *testing.T) {
	...
	for _, want := range []string{"3.2.test", "20", "242", "250", "391", "526", "735", "Rakanishu", "HellBovine", "CowKing"} {
