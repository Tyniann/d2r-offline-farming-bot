...
func NewBootstrapBackend(cfg *config.Config) (*BootstrapBackend, error) {
	...
	return &BootstrapBackend{
		status:  StatusDTO{CoreVersion: version.Version, State: "idle", D2R: D2RDTO{State: "detached"}, Input: InputDTO{Enabled: cfg.Input.Enabled}, World: WorldDTO{Phase: "unknown"}},
...
func (b *BootstrapBackend) statusSelectionDifficulty() string { return b.difficulty }
