...
//go:generate go run ../../tools/generate-item-catalog -src ../../.tmp/d2r-excel -version 3.2.92777 -out item_catalog_data.go -game-de-out ../../web/src/i18n/generated/game.de.json -game-en-out ../../web/src/i18n/generated/game.en.json
