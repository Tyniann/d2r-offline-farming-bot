...
var areaCatalog = map[AreaID]areaEntry{
	...
	100: {name: "Durance of Hate Level 1", kind: AreaKindUnknown},
	101: {name: "Durance of Hate Level 2", kind: AreaKindUnknown},
	102: {name: "Durance of Hate Level 3", kind: AreaKindUnknown},
