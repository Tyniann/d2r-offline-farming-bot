...
func validTownConfig() Config {
	return Config{present: true, Hub: HubConfig{Area: "rogue_encampment", RoutesDirectory: "routes/town/act1/graph", Anchors: []Anchor{AnchorSpawn, AnchorPortalArrival, AnchorStash, AnchorWaypoint, AnchorAkara, AnchorCharsi, AnchorCain, AnchorKashya}, Services: map[Service]Anchor{ServicePotions: AnchorAkara, ServiceScrolls: AnchorAkara, ServiceIdentify: AnchorCain, ServiceSell: AnchorAkara, ServiceRepair: AnchorCharsi, ServiceMercenaryHeal: AnchorAkara, ServiceMercenaryRevive: AnchorKashya}}, Egress: map[OriginAct]EgressConfig{OriginAct3: {Area: "kurast_docks", Anchors: []Anchor{AnchorPortalArrival, AnchorWaypoint}, RoutesDirectory: "routes/town/act3/egress"}}}
}
