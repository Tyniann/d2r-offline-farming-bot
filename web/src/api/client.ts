...
export function deletePickitProfile(id: string, request: PickitDeleteRequest): Promise<PickitDeleteResultDTO> { return pickitMutation(`/api/v1/pickit/profiles/${encodeURIComponent(id)}`, "DELETE", request); }
