    ...
    mocks.preview.mockResolvedValue({
      ...
      profiles: [{
        ...
        required_skills: [
          ...
          { skill: "amplify_damage", skill_id: 66, display_name: "Verstärkter Schaden" },
          { skill: "corpse_explosion", skill_id: 74, display_name: "Kadaverexplosion" },
          { skill: "bone_armor", skill_id: 68, display_name: "Knochenrüstung" },
          { skill: "bone_prison", skill_id: 88, display_name: "Knochengefängnis" },
        ],
