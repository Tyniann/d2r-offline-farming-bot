...
function setupPreview(character: string, overrides: Record<string, unknown> = {}) {
  return {
    ...
    supported: true,
    profiles: [
      { id: "necro_bone_spear", display_name: "Knochen-Speer", is_default: true, is_selected: character === "MrBones", standard_attack: "bone_spear", required_skills: [{ skill: "teleport", skill_id: 54, display_name: "Teleport" }], default_belt_layout: { slot_1: "healing", slot_2: "mana", slot_3: "mana", slot_4: "rejuvenation" }, belt_layout: { slot_1: "healing", slot_2: "mana", slot_3: "mana", slot_4: "rejuvenation" }, default_healing_restock: 2, default_mana_restock: 4 },
      { id: "necro_bone_spirit", display_name: "Knochengeist", is_default: false, is_selected: false, standard_attack: "bone_spirit", required_skills: [{ skill: "teleport", skill_id: 54, display_name: "Teleport" }], default_belt_layout: { slot_1: "healing", slot_2: "mana", slot_3: "mana", slot_4: "rejuvenation" }, belt_layout: { slot_1: "healing", slot_2: "mana", slot_3: "mana", slot_4: "rejuvenation" }, default_healing_restock: 2, default_mana_restock: 4 },
    ],
