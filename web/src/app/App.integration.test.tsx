...
it("durchläuft Queue, Pause, Resume, Stop und Emergency Stop gegen einen Fake-Core", async () => {
  ...
  const catalog = { schema_version: 1, revision: 8, default_difficulty: "nightmare", characters: [{ name: "MrBones", slug: "mrbones", selectable: true }], difficulties: [{ id: "nightmare", display_name: "Alptraum" }], profiles: [], runs: [{ run_id: "countess", display_name: "Countess", status: "runtime_validation_required" }, { run_id: "mephisto", display_name: "Mephisto", status: "runtime_validation_required" }, { run_id: "nihlathak", display_name: "Nihlathak", status: "unavailable" }, { run_id: "summoner", display_name: "Summoner", status: "unavailable" }] };
