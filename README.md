...
```powershell
# Windows-Installer bauen (dist/release/D2R-Offline-Farming-Bot-0.21.0-Setup.exe)
powershell -ExecutionPolicy Bypass -File scripts/build-release.ps1 -Version 0.21.0
...
```powershell
powershell -ExecutionPolicy Bypass -File scripts/build-release.ps1 -Version 0.21.0
# Ergebnis: dist\release\D2R-Offline-Farming-Bot-0.21.0-Setup.exe
```
