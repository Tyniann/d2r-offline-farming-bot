...
```powershell
powershell -ExecutionPolicy Bypass -File scripts/build-release.ps1 -Version 0.25.1,
```

Ergebnis: `dist/release/D2R-Offline-Farming-Bot-0.25.1-Setup.exe` plus SHA-256. Installer-Hinweise: [`docs/INSTALLATION.md`](docs/INSTALLATION.md).
